...
function Traceability() public{
  ...
  //this function updates the parent information for traceability 
     function updateProvenanceData(string memory information, bytes32 hash, address SC, address EA)public{
    ...
    function requestPersmission(bytes32 IPFShash) public{
    ...
    function AttestSC(bytes32 hash,  address SCaddress) public{
    ...
    function GrantAttestation(bool result, string memory infor, bytes32 hash, string memory meta, address SCaddress)public{
